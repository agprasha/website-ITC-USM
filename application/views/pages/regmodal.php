<div class="modal fade" id="reg" tabindex="-1" role="form" aria-labelledby="myModalLabel" aria-hidden="true">
  	<div class="modal-dialog">
            ...
            <div class="modal-body">
	    		<form action="home/register" method="post" id="itcreg">
	                ...
	                <div class="form-group">
	               	...
	               	<div class="form-group">
		                ...
		                <div class="input-group date"  id="tgl_lhr" data-date-format="YYYY-MM-DD">
		                    <input type="date" class="form-control" id="tanggal" name="tgl_lhr">
